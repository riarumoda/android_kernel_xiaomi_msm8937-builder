...
setup_environment() {
    ...
    export COMPILE_FEATURE_DEFCONFIG="vendor/feature/android-12.config vendor/feature/erofs.config vendor/feature/lineageos.config vendor/feature/lmkd.config vendor/feature/lto.config vendor/feature/wireguard.config"
    # KernelSU Settings
