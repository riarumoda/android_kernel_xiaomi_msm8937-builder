...
# Compatibility
Compatible with community ROM builds for [Mi8937 & Mi8917](https://t.me/mi_msm8937) with preloaded 4.19 kernel, also compatible with Official LineageOS for [Mi8937](https://download.lineageos.org/devices/Mi8937/builds) & [Mi8917](https://download.lineageos.org/devices/Mi8917/builds). Always make sure you have a kernel backup before proceeding. This kernel might gonna work on non-lineage based roms but it is not guaranteed.
